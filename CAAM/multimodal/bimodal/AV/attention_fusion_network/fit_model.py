...
training_FORMANT, training_facial,training_Y, training_X_gender = load_training_data()
...
while(current_epoch_number < no_of_downward_epochs):
	...
	hist = model.fit([training_FORMANT, training_facial,  training_X_gender], training_Y, batch_size = batch_size, epochs = 1)

	loss_train = hist.history['loss'][-1]
	loss_test = model.evaluate([test_FORMANT, test_facial, test_X_gender], test_Y, batch_size = test_FORMANT.shape[0])
