...
test_set_ID_list = [1004, 1005, 1009, 1012, 1014, 1029, 1037, 1041, 1050, 1055, 1069, 1072, 1083, 1088, 1090, 1091, 1095, 1104, 1112, 1115,
...
for ID in test_set_ID_list:
	data = pd.read_csv('./' + str(ID) + '_P/' + str(ID) + '_TRANSCRIPT.csv', sep='\t')
	transcript = data.values
	...
	with tf.Session() as session:
		...
		np.save('./individual_embeddings/' + str(ID) + '_TRANSCRIPT.npy',x)
		if (maxim < x.shape[0]):
			maxim = x.shape[0]
		print(maxim)
